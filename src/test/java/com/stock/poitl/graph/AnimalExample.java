...
public class AnimalExample {
    ...
    public void testAnimal() throws Exception {
        ...
        Map<String, Object> giraffe = new HashMap<String, Object>() {
            {
                put("name", "长颈鹿");
                put("picture", Pictures.ofLocal("D:\\poi\\pic\\graph\\lu.png").size(100, 120).create());
                put("chart",
        ...
        XWPFTemplate.compile("D:\\poi\\graph.docx").render(new HashMap<String, Object>() {
            {
                put("animals", animals);
            }
        }).writeToFile("./doc/out_example_animal.docx");
    }
