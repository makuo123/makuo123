...
public class OKRExample {
    ...
    public void testOKRExample() throws Exception {
        ...
        XWPFTemplate template = XWPFTemplate.compile("D:\\poi\\OKR.docx").render(data);
        template.writeToFile("./doc/out_example_okr.docx");
...
//        System.out.println(1.1 instanceof Double);
    }
