package com.stock.thread.transaction.aop;

import com.stock.thread.transaction.annotations.MainTransaction;
...
public class TransactionAop {
    ...
    @Around("@annotation(com.stock.thread.transaction.annotations.SonTransaction)")
