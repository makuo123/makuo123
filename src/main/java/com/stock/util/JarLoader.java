...
public class JarLoader {
    ...
    public void execute(String jarFileName, String reference, String methodName, Object ... params){
        ...
        try {
           ...
           // ICalculator cal = (ICalculator)aClass.newInstance();
            //System.out.println(cal.addNumbers(pList));
...
//            System.out.println(res);
    ...
    public static void main(String[] args) {
        String path = "E:\\workspace\\jar2demo\\out\\artifacts\\jar2demo_jar\\jar2demo.jar";
        JarLoader loader = new JarLoader();
        loader.loadJars(path);
        loader.execute("jar2demo.jar", "com.jar.Calculator", "addNumbers", new Object[]{1, 2, 3});
