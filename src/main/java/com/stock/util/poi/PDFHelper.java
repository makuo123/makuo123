...
public class PDFHelper {
    ...
    public static void main(String[] args) throws IOException {
        //pdf2doc("C:\\Users\\makuo\\Desktop\\lims.pdf");
        //  removeWatermark(new File("C:\\Users\\liuya\\Desktop\\pdf\\中信重工铸锻公司数字化工厂技术要求.docx"));
        //System.out.println(HexUtil.decodeHexStr("03B1"));
        System.out.println(UnicodeUtil.toString("234\u03BCV"));
    }
