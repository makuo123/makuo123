...
public class ZPLConveterUtils {
    ...
    private String headDoc() {
        String str = "^XA " + "^FO0,20^GFA," + total + "," + total + "," + widthBytes + ", ";
        return str;
    }
    ...
    private String createBody(BufferedImage orginalImage) throws IOException {
        /*Image tmp = orginalImage.getScaledInstance(80, 60, Image.SCALE_SMOOTH);
        BufferedImage dimg = new BufferedImage(80, 60, BufferedImage.TYPE_INT_ARGB);*/
        BufferedImage bufferedImage = ImageUtil.resizeBufferedImage(orginalImage, 600, 400, false);
