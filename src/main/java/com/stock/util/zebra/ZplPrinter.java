...
import com.stock.util.zebra.code.TwoDimensionCode;
import lombok.Data;
...
public class ZplPrinter {
    ...
    public static String Z_DESIGNER = "ZDesigner ZD888-203dpi ZPL";
    ...
    public static void printQRCOde(){
        ...
        ZplPrinter codeZplPrinter = new ZplPrinter(Z_DESIGNER);
        ...
        System.out.println(codeZplPrinter.getZpl());
...
//        printBarcode();
//        printQRCOde();
        ZplPrinter p = new ZplPrinter(Z_DESIGNER);
        ...
        p.setText("样品标识", 420, 20, 30, 30, 15, 1, 1, 24);


        p.setBegin(p.getBegin() + codeBegin);
        //设置二维码位置
        p.setContent(p.getContent() + "^FO400,70^XG"+Image2Zpl.imgLength+",1,1^FS\n");

        p.setText("样品编号:", 100, 50, 25, 25, 13, 1, 1, 24);
        p.setChar("TX2-18/03/09-0003", 100, 85, 22, 22);
        p.setText("委托编号:", 100, 120, 25, 25, 13, 1, 1, 24);
        p.setChar("CEPR1-TX2-2018-1300", 100, 155, 22, 22);
        p.setText("样品名称:生产制造执行系统", 100, 200, 25, 25, 13, 1, 1, 24);

        p.setText("待检", 100, 288, 30, 30, 15, 1, 1, 24);
        p.setBox(155, 288, 40, 25, 1);
        p.setText("在检", 205, 288, 30, 30, 15, 1, 1, 24);
        p.setBox(255, 288, 40, 25, 1);
        p.setText("已检", 305, 288, 30, 30, 15, 1, 1, 24);
        p.setBox(355, 290, 40, 25, 1);
        p.setText("留样", 405, 288, 30, 30, 15, 1, 1, 24);
        p.setBox(455, 288, 40, 25, 1);
...
//      第二种方法
    ...
    public ZplPrinter(String printerURI) {
        ...
        // 加载点阵字库 汉字需要
        File file = new File("src/main/resources/ts24.lib");
        if (file.exists()) {
            FileInputStream fis;
            try {
